...
typedef enum  {
	...
	PRECEDENCE_DIVIDE = 3,
	PRECEDENCE_NOT = 4,
	PRECEDENCE_FUNCTION = 5,
	PRECEDENCE_BOOLEAN = 6,
	PRECEDENCE_PERCENTAGE = 7,
	PRECEDENCE_UNARY_MINUS = 8,
	PRECEDENCE_POWER = 8,
	PRECEDENCE_ROOT = 8,
	PRECEDENCE_FACTORIAL = 9,
	PRECEDENCE_NUMBER_VARIABLE = 10,
	PRECEDENCE_DEPTH
} Precedence;
...
static Number* divide_node_real_solve_lr (LRNode* base, Number* l, Number* r) {
	...
	if (_tmp4_ != NULL) {
		...
		_tmp32_ = token_start;
		_tmp33_ = token_end;
		parser_set_error (_tmp29_, ERROR_CODE_MP, _tmp31_, _tmp32_, _tmp33_);
...
static gboolean parser_expression_1 (Parser* self) {
	...
	if (_tmp9_ == LEXER_TOKEN_TYPE_L_R_BRACKET) {
		...
		if (_tmp15_ == LEXER_TOKEN_TYPE_R_R_BRACKET) {
			...
			_tmp17_ = self->priv->lexer;
			_tmp18_ = lexer_get_next_token (_tmp17_);
			_g_object_unref0 (token);
			token = _tmp18_;
			...
			if (_tmp21_ == LEXER_TOKEN_TYPE_NUMBER) {
				guint _tmp22_ = 0U;
				Associativity _tmp23_ = 0;
				MultiplyNode* _tmp24_ = NULL;
				MultiplyNode* _tmp25_ = NULL;
				gboolean _tmp26_ = FALSE;
				_tmp22_ = parser_make_precedence_p (self, PRECEDENCE_MULTIPLY);
				_tmp23_ = parser_get_associativity_p (self, PRECEDENCE_MULTIPLY);
				_tmp24_ = multiply_node_new (self, NULL, _tmp22_, _tmp23_);
				_tmp25_ = _tmp24_;
		...
		if (_tmp28_ == LEXER_TOKEN_TYPE_L_S_BRACKET) {
			guint _tmp29_ = 0U;
			LexerToken* _tmp30_ = NULL;
			guint _tmp31_ = 0U;
			LexerToken* _tmp32_ = NULL;
			Associativity _tmp33_ = 0;
			RoundNode* _tmp34_ = NULL;
			RoundNode* _tmp35_ = NULL;
			...
			_tmp30_ = token;
			_tmp31_ = parser_make_precedence_p (self, PRECEDENCE_UNKNOWN);
			_tmp32_ = token;
			_tmp33_ = parser_get_associativity (self, _tmp32_);
			_tmp34_ = round_node_new (self, _tmp30_, _tmp31_, _tmp33_);
			_tmp35_ = _tmp34_;
			...
			if (_tmp40_ == LEXER_TOKEN_TYPE_R_S_BRACKET) {
				guint _tmp41_ = 0U;
				_tmp41_ = self->priv->depth_level;
				self->priv->depth_level = _tmp41_ - 1;
				result = TRUE;
				_g_object_unref0 (token);
				return result;
			} else {
			...
			_tmp42_ = token;
			_tmp43_ = _tmp42_->type;
			if (_tmp43_ == LEXER_TOKEN_TYPE_L_C_BRACKET) {
				guint _tmp44_ = 0U;
				LexerToken* _tmp45_ = NULL;
				guint _tmp46_ = 0U;
				LexerToken* _tmp47_ = NULL;
				Associativity _tmp48_ = 0;
				FractionalComponentNode* _tmp49_ = NULL;
				FractionalComponentNode* _tmp50_ = NULL;
				gboolean _tmp51_ = FALSE;
				Lexer* _tmp52_ = NULL;
				LexerToken* _tmp53_ = NULL;
				LexerToken* _tmp54_ = NULL;
				LexerTokenType _tmp55_ = 0;
				_tmp44_ = self->priv->depth_level;
				self->priv->depth_level = _tmp44_ + 1;
				_tmp45_ = token;
				_tmp46_ = parser_make_precedence_p (self, PRECEDENCE_UNKNOWN);
				_tmp47_ = token;
				_tmp48_ = parser_get_associativity (self, _tmp47_);
				_tmp49_ = fractional_component_node_new (self, _tmp45_, _tmp46_, _tmp48_);
				_tmp50_ = _tmp49_;
				parser_insert_into_tree_unary (self, (ParseNode*) _tmp50_);
				_g_object_unref0 (_tmp50_);
				_tmp51_ = parser_expression (self);
				if (!_tmp51_) {
					result = FALSE;
					_g_object_unref0 (token);
					return result;
				}
				_tmp52_ = self->priv->lexer;
				_tmp53_ = lexer_get_next_token (_tmp52_);
				_g_object_unref0 (token);
				token = _tmp53_;
				_tmp54_ = token;
				_tmp55_ = _tmp54_->type;
				if (_tmp55_ == LEXER_TOKEN_TYPE_R_C_BRACKET) {
					guint _tmp56_ = 0U;
					_tmp56_ = self->priv->depth_level;
					self->priv->depth_level = _tmp56_ - 1;
					result = TRUE;
					_g_object_unref0 (token);
					return result;
				} else {
				...
				LexerToken* _tmp57_ = NULL;
				LexerTokenType _tmp58_ = 0;
				_tmp57_ = token;
				_tmp58_ = _tmp57_->type;
				if (_tmp58_ == LEXER_TOKEN_TYPE_ABS) {
					guint _tmp59_ = 0U;
					LexerToken* _tmp60_ = NULL;
					guint _tmp61_ = 0U;
					LexerToken* _tmp62_ = NULL;
					Associativity _tmp63_ = 0;
					AbsoluteValueNode* _tmp64_ = NULL;
					AbsoluteValueNode* _tmp65_ = NULL;
					gboolean _tmp66_ = FALSE;
					Lexer* _tmp67_ = NULL;
					LexerToken* _tmp68_ = NULL;
					LexerToken* _tmp69_ = NULL;
					LexerTokenType _tmp70_ = 0;
					_tmp59_ = self->priv->depth_level;
					self->priv->depth_level = _tmp59_ + 1;
					_tmp60_ = token;
					_tmp61_ = parser_make_precedence_p (self, PRECEDENCE_UNKNOWN);
					_tmp62_ = token;
					_tmp63_ = parser_get_associativity (self, _tmp62_);
					_tmp64_ = absolute_value_node_new (self, _tmp60_, _tmp61_, _tmp63_);
					_tmp65_ = _tmp64_;
					parser_insert_into_tree_unary (self, (ParseNode*) _tmp65_);
					_g_object_unref0 (_tmp65_);
					_tmp66_ = parser_expression (self);
					if (!_tmp66_) {
						result = FALSE;
						_g_object_unref0 (token);
						return result;
					...
					if (_tmp70_ == LEXER_TOKEN_TYPE_ABS) {
						guint _tmp71_ = 0U;
						_tmp71_ = self->priv->depth_level;
						self->priv->depth_level = _tmp71_ - 1;
						result = TRUE;
						_g_object_unref0 (token);
						return result;
					} else {
					...
					_tmp72_ = token;
					_tmp73_ = _tmp72_->type;
					if (_tmp73_ == LEXER_TOKEN_TYPE_NOT) {
						LexerToken* _tmp74_ = NULL;
						guint _tmp75_ = 0U;
						LexerToken* _tmp76_ = NULL;
						Associativity _tmp77_ = 0;
						NotNode* _tmp78_ = NULL;
						NotNode* _tmp79_ = NULL;
						gboolean _tmp80_ = FALSE;
						_tmp74_ = token;
						_tmp75_ = parser_make_precedence_p (self, PRECEDENCE_NOT);
						_tmp76_ = token;
						_tmp77_ = parser_get_associativity (self, _tmp76_);
						_tmp78_ = not_node_new (self, _tmp74_, _tmp75_, _tmp77_);
						_tmp79_ = _tmp78_;
						parser_insert_into_tree_unary (self, (ParseNode*) _tmp79_);
						_g_object_unref0 (_tmp79_);
						_tmp80_ = parser_expression (self);
						if (!_tmp80_) {
							result = FALSE;
							_g_object_unref0 (token);
							return result;
						...
						LexerToken* _tmp81_ = NULL;
						LexerTokenType _tmp82_ = 0;
						_tmp81_ = token;
						_tmp82_ = _tmp81_->type;
						if (_tmp82_ == LEXER_TOKEN_TYPE_NUMBER) {
							LexerToken* _tmp83_ = NULL;
							LexerToken* _tmp84_ = NULL;
							LexerTokenType _tmp85_ = 0;
							guint _tmp86_ = 0U;
							LexerToken* _tmp87_ = NULL;
							Associativity _tmp88_ = 0;
							ConstantNode* _tmp89_ = NULL;
							ConstantNode* _tmp90_ = NULL;
							Lexer* _tmp91_ = NULL;
							...
							_tmp86_ = parser_make_precedence_t (self, _tmp85_);
							_tmp87_ = token;
							_tmp88_ = parser_get_associativity (self, _tmp87_);
							_tmp89_ = constant_node_new (self, _tmp83_, _tmp86_, _tmp88_);
							_tmp90_ = _tmp89_;
							parser_insert_into_tree (self, (ParseNode*) _tmp90_);
							_g_object_unref0 (_tmp90_);
							_tmp91_ = self->priv->lexer;
							_tmp92_ = lexer_get_next_token (_tmp91_);
							_g_object_unref0 (token);
							token = _tmp92_;
							...
							if (_tmp100_ == LEXER_TOKEN_TYPE_FUNCTION) {
								_tmp98_ = TRUE;
							} else {
								...
								_tmp98_ = _tmp102_ == LEXER_TOKEN_TYPE_VARIABLE;
							}
							if (_tmp98_) {
								_tmp97_ = TRUE;
							} else {
								...
								_tmp103_ = token;
								_tmp104_ = _tmp103_->type;
								_tmp97_ = _tmp104_ == LEXER_TOKEN_TYPE_SUB_NUMBER;
							}
							if (_tmp97_) {
								_tmp96_ = TRUE;
							} else {
								LexerToken* _tmp105_ = NULL;
								LexerTokenType _tmp106_ = 0;
								_tmp105_ = token;
								_tmp106_ = _tmp105_->type;
								_tmp96_ = _tmp106_ == LEXER_TOKEN_TYPE_ROOT;
							}
							if (_tmp96_) {
								_tmp95_ = TRUE;
							} else {
								...
								_tmp107_ = token;
								_tmp108_ = _tmp107_->type;
								_tmp95_ = _tmp108_ == LEXER_TOKEN_TYPE_ROOT_3;
							}
							if (_tmp95_) {
								_tmp94_ = TRUE;
							} else {
								LexerToken* _tmp109_ = NULL;
								LexerTokenType _tmp110_ = 0;
								_tmp109_ = token;
								_tmp110_ = _tmp109_->type;
								_tmp94_ = _tmp110_ == LEXER_TOKEN_TYPE_ROOT_4;
							}
							if (_tmp94_) {
								guint _tmp111_ = 0U;
								Associativity _tmp112_ = 0;
								MultiplyNode* _tmp113_ = NULL;
								MultiplyNode* _tmp114_ = NULL;
								gboolean _tmp115_ = FALSE;
								_tmp111_ = parser_make_precedence_p (self, PRECEDENCE_MULTIPLY);
								_tmp112_ = parser_get_associativity_p (self, PRECEDENCE_MULTIPLY);
								_tmp113_ = multiply_node_new (self, NULL, _tmp111_, _tmp112_);
								_tmp114_ = _tmp113_;
								parser_insert_into_tree (self, (ParseNode*) _tmp114_);
								_g_object_unref0 (_tmp114_);
								_tmp115_ = parser_variable (self);
								if (!_tmp115_) {
									result = FALSE;
									_g_object_unref0 (token);
									return result;
							...
							if (_tmp117_ == LEXER_TOKEN_TYPE_L_FLOOR) {
								guint _tmp118_ = 0U;
								guint _tmp119_ = 0U;
								Associativity _tmp120_ = 0;
								FloorNode* _tmp121_ = NULL;
								FloorNode* _tmp122_ = NULL;
								gboolean _tmp123_ = FALSE;
								Lexer* _tmp124_ = NULL;
								LexerToken* _tmp125_ = NULL;
								LexerToken* _tmp126_ = NULL;
								LexerTokenType _tmp127_ = 0;
								_tmp118_ = self->priv->depth_level;
								self->priv->depth_level = _tmp118_ + 1;
								_tmp119_ = parser_make_precedence_p (self, PRECEDENCE_UNKNOWN);
								_tmp120_ = parser_get_associativity_p (self, PRECEDENCE_UNKNOWN);
								_tmp121_ = floor_node_new (self, NULL, _tmp119_, _tmp120_);
								_tmp122_ = _tmp121_;
								parser_insert_into_tree_unary (self, (ParseNode*) _tmp122_);
								_g_object_unref0 (_tmp122_);
								_tmp123_ = parser_expression (self);
								if (!_tmp123_) {
									result = FALSE;
									_g_object_unref0 (token);
									return result;
								...
								if (_tmp127_ == LEXER_TOKEN_TYPE_R_FLOOR) {
									guint _tmp128_ = 0U;
									_tmp128_ = self->priv->depth_level;
									self->priv->depth_level = _tmp128_ - 1;
									result = TRUE;
									_g_object_unref0 (token);
									return result;
								} else {
								...
								if (_tmp130_ == LEXER_TOKEN_TYPE_L_CEILING) {
									guint _tmp131_ = 0U;
									guint _tmp132_ = 0U;
									Associativity _tmp133_ = 0;
									CeilingNode* _tmp134_ = NULL;
									CeilingNode* _tmp135_ = NULL;
									gboolean _tmp136_ = FALSE;
									Lexer* _tmp137_ = NULL;
									LexerToken* _tmp138_ = NULL;
									LexerToken* _tmp139_ = NULL;
									LexerTokenType _tmp140_ = 0;
									_tmp131_ = self->priv->depth_level;
									self->priv->depth_level = _tmp131_ + 1;
									_tmp132_ = parser_make_precedence_p (self, PRECEDENCE_UNKNOWN);
									_tmp133_ = parser_get_associativity_p (self, PRECEDENCE_UNKNOWN);
									_tmp134_ = ceiling_node_new (self, NULL, _tmp132_, _tmp133_);
									_tmp135_ = _tmp134_;
									parser_insert_into_tree_unary (self, (ParseNode*) _tmp135_);
									_g_object_unref0 (_tmp135_);
									_tmp136_ = parser_expression (self);
									if (!_tmp136_) {
										result = FALSE;
										_g_object_unref0 (token);
										return result;
									}
									_tmp137_ = self->priv->lexer;
									_tmp138_ = lexer_get_next_token (_tmp137_);
									_g_object_unref0 (token);
									token = _tmp138_;
									_tmp139_ = token;
									_tmp140_ = _tmp139_->type;
									if (_tmp140_ == LEXER_TOKEN_TYPE_R_CEILING) {
										guint _tmp141_ = 0U;
										_tmp141_ = self->priv->depth_level;
										self->priv->depth_level = _tmp141_ - 1;
										result = TRUE;
										_g_object_unref0 (token);
										return result;
									} else {
									...
									LexerToken* _tmp142_ = NULL;
									LexerTokenType _tmp143_ = 0;
									_tmp142_ = token;
									_tmp143_ = _tmp142_->type;
									if (_tmp143_ == LEXER_TOKEN_TYPE_SUBTRACT) {
										LexerToken* _tmp144_ = NULL;
										guint _tmp145_ = 0U;
										Associativity _tmp146_ = 0;
										UnaryMinusNode* _tmp147_ = NULL;
										UnaryMinusNode* _tmp148_ = NULL;
										gboolean _tmp149_ = FALSE;
										_tmp144_ = token;
										_tmp145_ = parser_make_precedence_p (self, PRECEDENCE_UNARY_MINUS);
										_tmp146_ = parser_get_associativity_p (self, PRECEDENCE_UNARY_MINUS);
										_tmp147_ = unary_minus_node_new (self, _tmp144_, _tmp145_, _tmp146_);
										_tmp148_ = _tmp147_;
										parser_insert_into_tree_unary (self, (ParseNode*) _tmp148_);
										_g_object_unref0 (_tmp148_);
										_tmp149_ = parser_expression_1 (self);
										if (!_tmp149_) {
											result = FALSE;
											_g_object_unref0 (token);
											return result;
										...
										LexerTokenType _tmp151_ = 0;
										_tmp150_ = token;
										_tmp151_ = _tmp150_->type;
										if (_tmp151_ == LEXER_TOKEN_TYPE_ADD) {
											Lexer* _tmp152_ = NULL;
											LexerToken* _tmp153_ = NULL;
											LexerToken* _tmp154_ = NULL;
											LexerTokenType _tmp155_ = 0;
											_tmp152_ = self->priv->lexer;
											_tmp153_ = lexer_get_next_token (_tmp152_);
											_g_object_unref0 (token);
											token = _tmp153_;
											_tmp154_ = token;
											_tmp155_ = _tmp154_->type;
											if (_tmp155_ == LEXER_TOKEN_TYPE_NUMBER) {
												LexerToken* _tmp156_ = NULL;
												LexerToken* _tmp157_ = NULL;
												LexerTokenType _tmp158_ = 0;
												guint _tmp159_ = 0U;
												LexerToken* _tmp160_ = NULL;
												Associativity _tmp161_ = 0;
												ConstantNode* _tmp162_ = NULL;
												ConstantNode* _tmp163_ = NULL;
												_tmp156_ = token;
												_tmp157_ = token;
												_tmp158_ = _tmp157_->type;
												_tmp159_ = parser_make_precedence_t (self, _tmp158_);
												_tmp160_ = token;
												_tmp161_ = parser_get_associativity (self, _tmp160_);
												_tmp162_ = constant_node_new (self, _tmp156_, _tmp159_, _tmp161_);
												_tmp163_ = _tmp162_;
												parser_insert_into_tree (self, (ParseNode*) _tmp163_);
											...
											_tmp164_ = self->priv->lexer;
											lexer_roll_back (_tmp164_);
											_tmp165_ = parser_variable (self);
											if (!_tmp165_) {
												result = FALSE;
												_g_object_unref0 (token);
												return result;
