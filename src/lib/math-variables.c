		...
		for (variable_it = 0; variable_it < _tmp7__length1; variable_it = variable_it + 1) {
			...
			variable = _tmp8_;
			{
				...
				if (_tmp12_) {
					...
					_vala_array_add5 (&eligible_variables, &eligible_variables_length1, &_eligible_variables_size_, _tmp15_);
				}
				_g_free0 (variable);
			}
		}
	}
	_tmp16_ = eligible_variables;
	_tmp16__length1 = eligible_variables_length1;
	if (result_length1) {
