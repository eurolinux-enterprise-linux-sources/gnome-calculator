/* equation-parser.c generated by valac 0.26.1, the Vala compiler
...
static Number* modulus_divide_node_real_solve (ParseNode* base) {
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp0_, TYPE_XPOW_YNODE)) {
		...
		Number* _tmp26_ = NULL;
		Number* _tmp27_ = NULL;
		_tmp18_ = ((ParseNode*) self)->left;
		_tmp19_ = parse_node_solve (_tmp18_);
		l = _tmp19_;
		_tmp20_ = ((ParseNode*) self)->right;
		_tmp21_ = parse_node_solve (_tmp20_);
		r = _tmp21_;
		_tmp23_ = l;
		if (_tmp23_ == NULL) {
			_tmp22_ = TRUE;
		...
		_tmp25_ = l;
		_tmp26_ = r;
		_tmp27_ = lr_node_solve_lr ((LRNode*) self, _tmp25_, _tmp26_);
		result = _tmp27_;
		_g_object_unref0 (r);
		_g_object_unref0 (l);
		return result;
