/* equation.c generated by valac 0.26.1, the Vala compiler
...
Number* equation_parse (Equation* self, guint* representation_base, ErrorCode* error_code, gchar** error_token, guint** error_start, guint** error_end) {
	...
	z = _tmp8_;
	_tmp13_ = _vala_error_code;
	if (_tmp13_ != ERROR_CODE_NONE) {
		result = NULL;
		_g_object_unref0 (z);
