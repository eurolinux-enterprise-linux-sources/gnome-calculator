/* function-manager.c generated by valac 0.26.1, the Vala compiler
...
static Number** _vala_array_dup10 (Number** self, int length);
...
static MathFunction** _vala_array_dup11 (MathFunction** self, int length);
...
static gchar** function_manager_array_sort_string (FunctionManager* self, gchar** array, int array_length1, int* result_length1) {
	...
	_tmp34_ = (_tmp33_ != NULL) ? _vala_array_dup9 (_tmp33_, _tmp33__length1) : ((gpointer) _tmp33_);
...
Number* function_manager_evaluate_function (FunctionManager* self, const gchar* name, Number** arguments, int arguments_length1, Parser* parser) {
	...
	_tmp3_ = (_tmp2_ != NULL) ? _vala_array_dup10 (_tmp2_, _tmp2__length1) : ((gpointer) _tmp2_);
...
static MathFunction** function_manager_array_sort_math_function (FunctionManager* self, MathFunction** array, int array_length1, int* result_length1) {
	...
	_tmp38_ = (_tmp37_ != NULL) ? _vala_array_dup11 (_tmp37_, _tmp37__length1) : ((gpointer) _tmp37_);
