/* gcalccmd.c generated by valac 0.26.1, the Vala compiler
...
void solve (const gchar* equation) {
	...
	if (_tmp28_ != NULL) {
		...
		gchar* _tmp33_ = NULL;
		_tmp29_ = stdout;
		_tmp30_ = result_serializer;
		_tmp31_ = z;
		_tmp32_ = serializer_to_string (_tmp30_, _tmp31_);
		_tmp33_ = _tmp32_;
		fprintf (_tmp29_, "%s\n", _tmp33_);
		_g_free0 (_tmp33_);
	} else {
		ErrorCode _tmp34_ = 0;
		_tmp34_ = ret;
		if (_tmp34_ == ERROR_CODE_MP) {
			FILE* _tmp35_ = NULL;
			gchar* _tmp36_ = NULL;
			gchar* _tmp37_ = NULL;
			_tmp35_ = stderr;
			_tmp36_ = mp_get_error ();
			_tmp37_ = _tmp36_;
