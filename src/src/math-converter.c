/* math-converter.c generated by valac 0.26.1, the Vala compiler
...
static void __lambda13_ (MathConverter* self);
static void math_converter_update_result_label (MathConverter* self);
static void ___lambda13__currency_manager_updated (CurrencyManager* _sender, gpointer self);
static void __lambda14_ (MathConverter* self, GParamSpec* pspec);
...
static void ___lambda13__currency_manager_updated (CurrencyManager* _sender, gpointer self) {
	__lambda13_ ((MathConverter*) self);
}
...
static void ___lambda14__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
	__lambda14_ ((MathConverter*) self, pspec);
}
...
MathConverter* math_converter_construct (GType object_type, MathEquation* equation) {
	...
	_tmp33_ = _tmp32_;
	g_signal_connect_object (_tmp33_, "updated", (GCallback) ___lambda13__currency_manager_updated, self, 0);
	_g_object_unref0 (_tmp33_);
	_tmp34_ = equation;
	g_signal_connect_object ((GObject*) _tmp34_, "notify::display", (GCallback) ___lambda14__g_object_notify, self, 0);
