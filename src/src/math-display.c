/* math-display.c generated by valac 0.26.1, the Vala compiler
...
static gboolean _gtk_text_iter_equal (const GtkTextIter* s1, const GtkTextIter* s2);
...
MathDisplay* math_display_construct (GType object_type, MathEquation* equation) {
	...
	_tmp11_ = gtk_style_context_get_font (_tmp10_, GTK_STATE_FLAG_NORMAL);
	_tmp12_ = __vala_PangoFontDescription_copy0 (_tmp11_);
	font_desc = _tmp12_;
	pango_font_description_set_size (font_desc, 16 * PANGO_SCALE);
	_tmp13_ = self->priv->source_view;
	gtk_widget_override_font ((GtkWidget*) _tmp13_, font_desc);
	_tmp14_ = self->priv->source_view;
	gtk_buildable_set_name ((GtkBuildable*) _tmp14_, "displayitem");
	_tmp15_ = self->priv->source_view;
	_tmp16_ = gtk_widget_get_accessible ((GtkWidget*) _tmp15_);
	atk_object_set_role (_tmp16_, ATK_ROLE_EDITBAR);
	_tmp17_ = self->priv->source_view;
	g_signal_connect_object ((GtkWidget*) _tmp17_, "key-press-event", (GCallback) _math_display_key_press_cb_gtk_widget_key_press_event, self, 0);
	math_display_create_autocompletion (self);
	_tmp18_ = self->priv->source_view;
	gtk_box_pack_start (main_box, (GtkWidget*) _tmp18_, TRUE, TRUE, (guint) 0);
	...
	_tmp21_ = gtk_text_view_get_buffer (info_view);
	_tmp22_ = _g_object_ref0 (_tmp21_);
	_g_object_unref0 (self->priv->info_buffer);
	self->priv->info_buffer = _tmp22_;
	_tmp23_ = (GtkSpinner*) gtk_spinner_new ();
	g_object_ref_sink (_tmp23_);
	_g_object_unref0 (self->priv->spinner);
	self->priv->spinner = _tmp23_;
	_tmp24_ = self->priv->spinner;
	gtk_box_pack_end (info_box, (GtkWidget*) _tmp24_, FALSE, FALSE, (guint) 0);
	gtk_widget_show ((GtkWidget*) info_box);
	gtk_widget_show ((GtkWidget*) info_view);
	_tmp25_ = self->priv->source_view;
	gtk_widget_show ((GtkWidget*) _tmp25_);
	gtk_widget_show ((GtkWidget*) main_box);
	_tmp26_ = equation;
	g_signal_connect_object ((GObject*) _tmp26_, "notify::status", (GCallback) ___lambda11__g_object_notify, self, 0);
	math_display_status_changed_cb (self);
	_tmp27_ = equation;
	g_signal_connect_object ((GObject*) _tmp27_, "notify::error-token-end", (GCallback) ___lambda12__g_object_notify, self, 0);
...
static void math_display_create_autocompletion (MathDisplay* self) {
	...
	__catch8_g_error:
	{
		...
		e = _inner_error_;
		_inner_error_ = NULL;
		g_warning ("math-display.vala:88: Could not add CompletionProvider to source-view");
		_g_error_free0 (e);
	}
	__finally8:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
static void function_completion_provider_real_populate (CompletionProvider* base, GtkSourceCompletionContext* context) {
	...
	GtkSourceCompletionContext* _tmp54_ = NULL;
	GList* _tmp55_ = NULL;
	self = (FunctionCompletionProvider*) base;
	g_return_if_fail (context != NULL);
	emptyiter = _tmp0_;
	...
	_tmp3_ = iter1;
	_tmp4_ = emptyiter;
	if (_gtk_text_iter_equal (&_tmp3_, &_tmp4_) == TRUE) {
		return;
	}
	_tmp5_ = gtk_text_iter_get_buffer (&iter1);
	_tmp6_ = _g_object_ref0 (_tmp5_);
	text_buffer = _tmp6_;
	_tmp7_ = text_buffer;
	_tmp9_ = function_completion_provider_get_matches_for_completion_at_cursor (_tmp7_, &_tmp8_);
	functions = _tmp9_;
	...
	if (_tmp10__length1 > 0) {
		...
		proposals = NULL;
		_tmp11_ = functions;
		_tmp11__length1 = functions_length1;
		{
			MathFunction** function_collection = NULL;
			gint function_collection_length1 = 0;
			gint _function_collection_size_ = 0;
			gint function_it = 0;
			function_collection = _tmp11_;
			function_collection_length1 = _tmp11__length1;
			for (function_it = 0; function_it < _tmp11__length1; function_it = function_it + 1) {
				MathFunction* _tmp12_ = NULL;
				MathFunction* function = NULL;
				_tmp12_ = _g_object_ref0 (function_collection[function_it]);
				function = _tmp12_;
				{
					...
					GtkSourceCompletionItem* _tmp52_ = NULL;
					GtkSourceCompletionItem* _tmp53_ = NULL;
					_tmp13_ = function;
					_tmp14_ = math_function_get_name (_tmp13_);
					_tmp15_ = _tmp14_;
					_tmp16_ = function;
					_tmp17_ = math_function_get_arguments (_tmp16_, &_tmp17__length1);
					_tmp18_ = _tmp17_;
					_tmp18__length1 = _tmp17__length1;
					_tmp19_ = _vala_g_strjoinv (";", _tmp18_, _tmp18__length1);
					_tmp20_ = _tmp19_;
					_tmp21_ = g_strdup_printf ("%s(%s)", _tmp15_, _tmp20_);
					_tmp22_ = _tmp21_;
					_g_free0 (_tmp20_);
					display_text = _tmp22_;
					_tmp23_ = function;
					_tmp24_ = math_function_get_description (_tmp23_);
					_tmp25_ = _tmp24_;
					_tmp26_ = g_strdup_printf ("%s", _tmp25_);
					details_text = _tmp26_;
					_tmp27_ = function;
					_tmp28_ = math_function_get_name (_tmp27_);
					_tmp29_ = _tmp28_;
					_tmp30_ = g_strconcat (_tmp29_, "()", NULL);
					label_text = _tmp30_;
					_tmp31_ = function;
					_tmp32_ = math_function_is_custom_function (_tmp31_);
					if (_tmp32_) {
						...
						MathFunction* _tmp44_ = NULL;
						const gchar* _tmp45_ = NULL;
						const gchar* _tmp46_ = NULL;
						gchar* _tmp47_ = NULL;
						_tmp33_ = function;
						_tmp34_ = math_function_get_name (_tmp33_);
						_tmp35_ = _tmp34_;
						_tmp36_ = function;
						_tmp37_ = math_function_get_arguments (_tmp36_, &_tmp37__length1);
						_tmp38_ = _tmp37_;
						_tmp38__length1 = _tmp37__length1;
						_tmp39_ = _vala_g_strjoinv (";", _tmp38_, _tmp38__length1);
						_tmp40_ = _tmp39_;
						_tmp41_ = function;
						_tmp42_ = math_function_get_expression (_tmp41_);
						_tmp43_ = _tmp42_;
						_tmp44_ = function;
						_tmp45_ = math_function_get_description (_tmp44_);
						_tmp46_ = _tmp45_;
						_tmp47_ = g_strdup_printf ("%s(%s)=%s\n%s", _tmp35_, _tmp40_, _tmp43_, _tmp46_);
						_g_free0 (details_text);
						details_text = _tmp47_;
						_g_free0 (_tmp40_);
					}
					_tmp48_ = display_text;
					_tmp49_ = label_text;
					_tmp50_ = details_text;
					_tmp51_ = gtk_source_completion_item_new (_tmp48_, _tmp49_, NULL, _tmp50_);
					proposal = _tmp51_;
					_tmp52_ = proposal;
					_tmp53_ = _g_object_ref0 (_tmp52_);
					proposals = g_list_append (proposals, _tmp53_);
	...
	_tmp54_ = context;
	_tmp55_ = proposals;
	gtk_source_completion_context_add_proposals (_tmp54_, (GtkSourceCompletionProvider*) self, _tmp55_, TRUE);
	__g_list_free__g_object_unref0_0 (proposals);
	functions = (_vala_array_free (functions, functions_length1, (GDestroyNotify) g_object_unref), NULL);
...
static void variable_completion_provider_real_populate (CompletionProvider* base, GtkSourceCompletionContext* context) {
	...
	gchar** _tmp13_ = NULL;
	gint _tmp13__length1 = 0;
	GtkSourceCompletionContext* _tmp37_ = NULL;
	GList* _tmp38_ = NULL;
	self = (VariableCompletionProvider*) base;
	g_return_if_fail (context != NULL);
	emptyiter = _tmp0_;
	...
	_tmp10_ = _tmp9_;
	_tmp12_ = variable_completion_provider_get_matches_for_completion_at_cursor (_tmp7_, _tmp10_, &_tmp11_);
	variables = _tmp12_;
	variables_length1 = _tmp11_;
	_variables_size_ = variables_length1;
	proposals = NULL;
	_tmp13_ = variables;
	...
	if (_tmp13__length1 > 0) {
		...
		_tmp14__length1 = variables_length1;
		{
			...
			gint variable_it = 0;
			variable_collection = _tmp14_;
			variable_collection_length1 = _tmp14__length1;
			for (variable_it = 0; variable_it < _tmp14__length1; variable_it = variable_it + 1) {
				gchar* _tmp15_ = NULL;
				gchar* variable = NULL;
				_tmp15_ = g_strdup (variable_collection[variable_it]);
				variable = _tmp15_;
				{
					gchar* display_text = NULL;
					...
					Serializer* _tmp20_ = NULL;
					MathEquation* _tmp21_ = NULL;
					MathVariables* _tmp22_ = NULL;
					MathVariables* _tmp23_ = NULL;
					const gchar* _tmp24_ = NULL;
					Number* _tmp25_ = NULL;
					Number* _tmp26_ = NULL;
					gchar* _tmp27_ = NULL;
					...
					GtkSourceCompletionItem* _tmp35_ = NULL;
					GtkSourceCompletionItem* _tmp36_ = NULL;
					_tmp16_ = variable;
					_tmp17_ = g_strdup_printf ("%s", _tmp16_);
					display_text = _tmp17_;
					_tmp18_ = self->priv->_equation;
					_tmp19_ = math_equation_get_serializer (_tmp18_);
					_tmp20_ = _tmp19_;
					_tmp21_ = self->priv->_equation;
					_tmp22_ = math_equation_get_variables (_tmp21_);
					_tmp23_ = _tmp22_;
					_tmp24_ = variable;
					_tmp25_ = math_variables_get (_tmp23_, _tmp24_);
					_tmp26_ = _tmp25_;
					_tmp27_ = serializer_to_string (_tmp20_, _tmp26_);
					_tmp28_ = _tmp27_;
					_g_object_unref0 (_tmp26_);
					details_text = _tmp28_;
					_tmp29_ = variable;
					_tmp30_ = g_strdup (_tmp29_);
					label_text = _tmp30_;
					_tmp31_ = display_text;
					_tmp32_ = label_text;
					_tmp33_ = details_text;
					_tmp34_ = gtk_source_completion_item_new (_tmp31_, _tmp32_, NULL, _tmp33_);
					proposal = _tmp34_;
					_tmp35_ = proposal;
					_tmp36_ = _g_object_ref0 (_tmp35_);
					proposals = g_list_append (proposals, _tmp36_);
					_g_object_unref0 (proposal);
					_g_free0 (label_text);
					_g_free0 (details_text);
					_g_free0 (display_text);
	...
	_tmp37_ = context;
	_tmp38_ = proposals;
	gtk_source_completion_context_add_proposals (_tmp37_, (GtkSourceCompletionProvider*) self, _tmp38_, TRUE);
	__g_list_free__g_object_unref0_0 (proposals);
	variables = (_vala_array_free (variables, variables_length1, (GDestroyNotify) g_free), NULL);
	_g_object_unref0 (text_buffer);
}
