...
MathDisplay* math_display_construct (GType object_type, MathEquation* equation) {
	...
	HistoryView* _tmp5_ = NULL;
	HistoryView* _tmp6_ = NULL;
	HistoryView* _tmp7_ = NULL;
	...
	PangoFontDescription* _tmp19_ = NULL;
	...
	gtk_text_view_set_justification ((GtkTextView*) _tmp14_, GTK_JUSTIFY_RIGHT);
	...
	_tmp18_ = gtk_style_context_get_font (style_context, GTK_STATE_FLAG_NORMAL);
	_tmp19_ = __vala_PangoFontDescription_copy0 (_tmp18_);
	font_desc = _tmp19_;
	gtk_style_context_restore (style_context);
	pango_font_description_set_size (font_desc, 16 * PANGO_SCALE);
	_tmp20_ = self->priv->source_view;
	gtk_widget_override_font ((GtkWidget*) _tmp20_, font_desc);
	_tmp21_ = self->priv->source_view;
	gtk_buildable_set_name ((GtkBuildable*) _tmp21_, "displayitem");
	_tmp22_ = self->priv->source_view;
	gtk_widget_set_size_request ((GtkWidget*) _tmp22_, 20, 20);
	_tmp23_ = self->priv->source_view;
	_tmp24_ = gtk_widget_get_accessible ((GtkWidget*) _tmp23_);
	atk_object_set_role (_tmp24_, ATK_ROLE_EDITBAR);
	_tmp25_ = self->priv->source_view;
	g_signal_connect_object ((GtkWidget*) _tmp25_, "key-press-event", (GCallback) _math_display_key_press_cb_gtk_widget_key_press_event, self, 0);
	...
	gtk_container_add ((GtkContainer*) scrolled_window, (GtkWidget*) _tmp26_);
	...
	_tmp29_ = gtk_text_view_get_buffer (info_view);
	_tmp30_ = _g_object_ref0 (_tmp29_);
	_g_object_unref0 (self->priv->info_buffer);
	self->priv->info_buffer = _tmp30_;
...
static void math_display_create_autocompletion (MathDisplay* self) {
	...
	__catch4_g_error:
	{
		...
		e = _inner_error_;
		_inner_error_ = NULL;
		g_warning ("math-display.vala:131: Could not add CompletionProvider to source-view");
		_g_error_free0 (e);
	}
	__finally4:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
static gboolean math_display_key_press_cb (MathDisplay* self, GdkEventKey* event) {
	...
	GdkModifierType _tmp50_ = 0;
	GdkModifierType _tmp73_ = 0;
	...
	if (_tmp80_) {
		MathEquation* _tmp86_ = NULL;
		MathEquation* _tmp87_ = NULL;
		gboolean _tmp88_ = FALSE;
		gboolean _tmp89_ = FALSE;
		GdkEventKey* _tmp92_ = NULL;
		guint _tmp93_ = 0U;
		...
		if (_tmp114_) {
			...
			switch (_tmp127_) {
				...
				case GDK_KEY_KP_8:
				{
					MathEquation* _tmp144_ = NULL;
					MathEquation* _tmp145_ = NULL;
				...
				case GDK_KEY_KP_9:
				{
					MathEquation* _tmp146_ = NULL;
					MathEquation* _tmp147_ = NULL;
