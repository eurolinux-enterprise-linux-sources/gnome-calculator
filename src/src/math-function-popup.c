/* math-function-popup.c generated by valac 0.26.1, the Vala compiler
...
static gboolean __lambda23_ (MathFunctionPopup* self, GdkEventFocus* event);
...
static gboolean ___lambda23__gtk_widget_focus_out_event (GtkWidget* _sender, GdkEventFocus* event, gpointer self) {
	gboolean result;
	result = __lambda23_ ((MathFunctionPopup*) self, event);
	return result;
}
