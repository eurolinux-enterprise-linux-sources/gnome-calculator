/* math-function.c generated by valac 0.26.1, the Vala compiler
...
static Number** _vala_array_dup6 (Number** self, int length);
...
FunctionParser* function_parser_construct (GType object_type, MathFunction* function, Parser* root_parser, Number** parameters, int parameters_length1) {
	...
	_tmp7_ = (_tmp6_ != NULL) ? _vala_array_dup6 (_tmp6_, _tmp6__length1) : ((gpointer) _tmp6_);
