/* math-preferences.c generated by valac 0.26.1, the Vala compiler
...
static void __math_preferences_dialog___lambda34__gtk_spin_button_value_changed (GtkSpinButton* _sender, gpointer self);
...
static void _math_preferences_dialog___lambda36_ (MathPreferencesDialog* self);
void math_equation_set_show_thousands_separators (MathEquation* self, gboolean value);
static void __math_preferences_dialog___lambda36__gtk_toggle_button_toggled (GtkToggleButton* _sender, gpointer self);
...
static void _math_preferences_dialog___lambda37_ (MathPreferencesDialog* self, GParamSpec* pspec);
...
static void _math_preferences_dialog___lambda39_ (MathPreferencesDialog* self);
...
static void _math_preferences_dialog___lambda42_ (MathPreferencesDialog* self, GParamSpec* pspec);
static void __math_preferences_dialog___lambda42__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self);
...
static void __math_preferences_dialog___lambda36__gtk_toggle_button_toggled (GtkToggleButton* _sender, gpointer self) {
	_math_preferences_dialog___lambda36_ ((MathPreferencesDialog*) self);
}
...
static void __math_preferences_dialog___lambda37__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
	_math_preferences_dialog___lambda37_ ((MathPreferencesDialog*) self, pspec);
}
...
static void __math_preferences_dialog___lambda39__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
	_math_preferences_dialog___lambda39_ ((MathPreferencesDialog*) self);
}
...
static void __math_preferences_dialog___lambda42__g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
	_math_preferences_dialog___lambda42_ ((MathPreferencesDialog*) self, pspec);
}
...
static GObject * math_preferences_dialog_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	_tmp67_ = gtk_adjustment_new (0.0, 0.0, 9.0, 1.0, 1.0, 0.0);
	...
	g_signal_connect_object (_tmp82_, "value-changed", (GCallback) __math_preferences_dialog___lambda34__gtk_spin_button_value_changed, self, 0);
	_tmp83_ = places_box;
	...
	g_signal_connect_object ((GtkToggleButton*) _tmp99_, "toggled", (GCallback) __math_preferences_dialog___lambda35__gtk_toggle_button_toggled, self, 0);
	...
	g_signal_connect_object ((GtkToggleButton*) _tmp105_, "toggled", (GCallback) __math_preferences_dialog___lambda36__gtk_toggle_button_toggled, self, 0);
	...
	_tmp111_ = label;
	g_object_set ((GtkMisc*) _tmp111_, "xalign", (gfloat) 0, NULL);
	_tmp112_ = grid;
	_tmp113_ = label;
	...
	_tmp147_ = label;
	g_object_set ((GtkMisc*) _tmp147_, "xalign", (gfloat) 0, NULL);
	_tmp148_ = grid;
	_tmp149_ = label;
	...
	g_signal_connect_object ((GObject*) _tmp189_, "notify::accuracy", (GCallback) __math_preferences_dialog___lambda37__g_object_notify, self, 0);
	...
	g_signal_connect_object ((GObject*) _tmp194_, "notify::show-thousands-separators", (GCallback) __math_preferences_dialog___lambda38__g_object_notify, self, 0);
	...
	g_signal_connect_object ((GObject*) _tmp199_, "notify::show-trailing_zeroes", (GCallback) __math_preferences_dialog___lambda39__g_object_notify, self, 0);
	...
	g_signal_connect_object ((GObject*) _tmp204_, "notify::number-format", (GCallback) __math_preferences_dialog___lambda40__g_object_notify, self, 0);
	...
	g_signal_connect_object ((GObject*) _tmp209_, "notify::word-size", (GCallback) __math_preferences_dialog___lambda41__g_object_notify, self, 0);
	...
	g_signal_connect_object ((GObject*) _tmp214_, "notify::angle-units", (GCallback) __math_preferences_dialog___lambda42__g_object_notify, self, 0);
