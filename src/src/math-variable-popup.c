/* math-variable-popup.c generated by valac 0.26.1, the Vala compiler
...
static gboolean __lambda22_ (MathVariablePopup* self, GdkEventFocus* event);
static gboolean ___lambda22__gtk_widget_focus_out_event (GtkWidget* _sender, GdkEventFocus* event, gpointer self);
...
static gboolean ___lambda22__gtk_widget_focus_out_event (GtkWidget* _sender, GdkEventFocus* event, gpointer self) {
	gboolean result;
	result = __lambda22_ ((MathVariablePopup*) self, event);
	return result;
}
